...
public class StandingsData : IStandingData
{
    ...
    private void ParseStandingsPage(CeefaxSectionType section)
    {
        ...
        // Drivers
        var drivers = doc.DocumentNode.SelectNodes("//section[@id='Drivers']//tr[@class='ssrcss-17njjoj-TableRowBody e1icz100']");
        ...
        // Constructors
        var constructors = doc.DocumentNode.SelectNodes("//section[@id='Constructors']//tr[@class='ssrcss-17njjoj-TableRowBody e1icz100']");
