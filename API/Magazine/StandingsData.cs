...
public class StandingsData : IStandingData
{
    ...
    private void ParseStandingsPage(CeefaxSectionType section)
    {
        ...
        // Drivers
        var drivers = doc.DocumentNode.SelectNodes("//section[@id='Drivers']//tr[@class='ssrcss-dhlz6k-TableRowBody e1xoxfm60']");
        ...
        // Constructors
        var constructors = doc.DocumentNode.SelectNodes("//section[@id='Constructors']//tr[@class='ssrcss-dhlz6k-TableRowBody e1xoxfm60']");
